...
💡 ~~Dark/Light mode toggle~~ [Added in 0.4.0](https://github.com/aarongustafson/hylia/releases/tag/0.4.0)  
🗣 Webmentions  
📖 Pagination  
...
1. Clone or fork this repo: `git clone https://github.com/aarongustafson/hylia`
...
To change the design tokens directly, edit [`_src/data/tokens.json`](https://github.com/aarongustafson/hylia/blob/master/src/_data/tokens.json).
...
You can edit the Styleguide by opening [`src/styleguide.njk`](https://github.com/aarongustafson/hylia/blob/master/src/styleguide.njk). If you don’t want the Styleguide, delete that file and the page will vanish.
...
The whole Sass system is powered by central config file, which lives here: [`_src/scss/_config.scss`](https://github.com/aarongustafson/hylia/blob/master/src/scss/_config.scss).

Before Sass is compiled, a `_tokens.scss` file is generated from the [design tokens config](https://github.com/aarongustafson/hylia/blob/master/src/_data/tokens.json) which is required.
...
Hylia has [Netlify CMS](https://www.netlifycms.org/) pre-configured as standard. You can customise the configuration by editing [`src/admin/config.yml`](https://github.com/aarongustafson/hylia/blob/master/src/admin/config.yml).
...
This project is _super_ early and feedback is very much welcome. In order to keep things running smooth, please consult the [contribution guide and code of conduct](https://github.com/aarongustafson/hylia/blob/master/contributing.md).
...
[deploy-to-netlify]: https://app.netlify.com/start/deploy?repository=https://github.com/aarongustafson/hylia&stack=cms
